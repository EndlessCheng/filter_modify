...
if _FIRST_CHAR:
    ...
    LEVELING_GEMS_BASE_TYPE = '"Vortex" "Increased Duration" "Immortal Call" "Cast when Damage Taken" '

    NEED_MAP = True

    HALLOWED_MAX_ITEM_LEVEL = 41
    ...
    # >= 2 找到高pDPS武器就隐藏所有白武器
    HIDE_NORMAL = '"Two Hand Maces" "Staves" ' + ' "Two Hand"'
