...
SSF_CRAFT_BELTS_BASE_TYPE = ''  # + ' "Leather Belt" '
...
CURRENCY_PORTAL_SCROLL_FONT_SIZE = [33, 30][0]
CURRENCY_WISDOM_SCROLL_FONT_SIZE = [33, 18][1]

HIDE_FLASK_MANA = True
HALLOWED_MAX_ITEM_LEVEL = [50, 41][1]  # 50 -> 41
...
SSF_CRAFT_BASE_TYPE = ''# + ' "Opal Sceptre" "Void Sceptre" '
...
HIDE_ENDGAME_BELOW_T2_RARE_CLASS = '"Bows" "Quivers" "One Hand" "Claws" "Two Hand" "Staves"   "Body Armour"  "Boots" "Gloves" "Helmets"  ' + ' "Shields" ' + ' "Daggers" ' + ' "Sceptres" "Wands" '
